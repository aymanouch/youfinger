...
import './proshow.css';
function ProShow ({name, price, prevPrice, id, type, img, perfume}) {
    ...
    return (
       ...
       <div className="proshow-container">
          ...
          <div className="img-flower__flower1">{perfume&&<img alt="flower" src="./images/design-images/flower02.png" />}</div>
